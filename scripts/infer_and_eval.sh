...
# MODEL="/home/qianq/mycodes/llm/results/swift-projector-llava-med-v1.5-mistral-7b-EPOCH=1-LR=1e-6-DATASET=attr-lidc/v0-20250811-042955/checkpoint-164"
...
python evaluate_results.py --input_file "$RESULT_PATH"
